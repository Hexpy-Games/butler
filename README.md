...
[v0.0.14 GitHub Release](https://github.com/Hexpy-Games/butler/releases/tag/v0.0.14).

| Platform | Installer |
| --- | --- |
| macOS Apple Silicon | `butler-app-0.0.14-darwin-arm64.pkg` |
| Linux x64 | `butler-app-0.0.14-linux-x64.deb` |
| Linux ARM64 | `butler-app-0.0.14-linux-arm64.deb` |
| Arch Linux x64 | `butler-app-0.0.14-1-x86_64.pkg.tar.zst` |
...
```bash
cd ~
wget https://github.com/Hexpy-Games/butler/releases/download/v0.0.14/butler-agent-0.0.14-all.tar.gz
mkdir -p ~/butler
...
Butler is `v0.0.14` and pre-release. Expect breaking changes before `v1.0.0`.
