...
[v0.0.24 GitHub Release](https://github.com/Hexpy-Games/butler/releases/tag/v0.0.24).

| Platform | Installer |
| --- | --- |
| macOS Apple Silicon | `butler-app-0.0.24-darwin-arm64.dmg` |
| Linux x64 | `butler-app-0.0.24-linux-x64.deb` |
| Linux ARM64 | `butler-app-0.0.24-linux-arm64.deb` |
| Arch Linux x64 | `butler-app-0.0.24-archlinux-x64.pkg.tar.zst` |
| Windows x64 | `butler-app-0.0.24-win32-x64-community-setup.exe` |
...
```bash
cd ~
wget https://github.com/Hexpy-Games/butler/releases/download/v0.0.24/butler-agent-0.0.24-all.tar.gz
mkdir -p ~/butler
...
Butler is `v0.0.24` and pre-release. Expect breaking changes before `v1.0.0`.
