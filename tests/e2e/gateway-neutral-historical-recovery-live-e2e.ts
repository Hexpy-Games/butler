...
const model = normalizeE2eModel(process.env.BUTLER_GNCC_RECOVERY_E2E_MODEL || "openai/gpt-5.5");
...
try {
  ...
  assert(model === "openai/gpt-5.5", `GNCC recovery live E2E must use GPT-5.5, got ${model}`);
