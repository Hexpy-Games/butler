...
const inventory: InventoryEntry[] = [
  ...
  entry("packages/butler-agent/src/interfaces/gateway/session-actor.ts", 842, 8, ["../../integrations/providers/provider-errors.ts", "../../runtime/internal-recovery-failure.ts"], "gateway session actor", "legacy exception; provider failure classification stays delegated", true),
  ...
  entry("packages/butler-agent/src/integrations/providers/provider-errors.ts", 269, 2, ["./operational-errors.ts", "../../runtime/internal-recovery-failure.ts"], "provider diagnostics", "keep under 300 lines with operational-errors and internal-recovery-failure owning shared taxonomy"),
  entry("packages/butler-agent/src/agent/turn/runtime-delivery-state.ts", 269, 3, ["./runtime-cancellation.ts", "./operational-failure.ts", "../../runtime/internal-recovery-failure.ts"], "runtime delivery taxonomy", "keep under 300 lines with focused operational/cancellation/recovery helpers"),
  entry("packages/butler-agent/src/runtime/internal-recovery-failure.ts", 114, 0, [], "internal recovery failure taxonomy", "own goal-completion, tool-surface, argument-repair, and evidence-recovery classification"),
