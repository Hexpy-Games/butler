...
const inventory: InventoryEntry[] = [
  ...
  entry("packages/butler-agent/src/agent/turn/native-tool-loop.ts", 3364, 36, ["./tool-loop-guards.ts", "./bridge-tool-executor.ts", "./tool-surface-prompt-controller.ts", "./completion-review-orchestrator.ts"], "native runtime loop", "keep direct-turn orchestration thin by delegating loop guards, tool surface state, and bridge execution", true),
