...
const inventory: InventoryEntry[] = [
  ...
  entry("packages/butler-agent/src/agent/turn/native-tool-loop.ts", 3691, 34, ["../tools/tool-surface-selection.ts", "../tools/tool-bridge/audit.ts", "./completion-review-orchestrator.ts"], "native runtime loop", "split direct-turn budget, tool-surface orchestration, and bridge loop helpers", true),
