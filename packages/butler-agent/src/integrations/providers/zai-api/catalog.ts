...
export const ZAI_API_SOURCE = "https://docs.z.ai/guides/overview/quick-start";

const ZAI_API_REASONING: ReasoningEffort[] = ["none", "low", "medium", "high", "xhigh", "max"];

function zaiApiModel(input: {
  modelId: string;
  displayName: string;
  ...
  return {
    ...
    model_ref: `zai-api/${input.modelId}`,
