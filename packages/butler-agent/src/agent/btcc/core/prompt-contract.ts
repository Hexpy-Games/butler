export const PROMPT_DUTY_IDS = [
  ...
  "candidate_revision_lineage", "requested_content", "related_memory",
  "connected_current_knowledge", "user_preferences_and_resolution_style",
  "expert_perspective", "intended_result_and_acceptance",
  "select_exact_governing_spec_logical_ids", "review_goal_contract_exactly",
  ...
  "review_effect_authority", "review_artifact_lifecycle", "execute_accepted_task",
  ...
  "review_correction_exactly", "assure_original_goal", "assure_normative_goal_sets",
