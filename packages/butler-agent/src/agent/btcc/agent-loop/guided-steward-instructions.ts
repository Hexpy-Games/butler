...
export function guidedStewardInstructions(
  ...
  return [
    ...
    "Choose direct execution or Worker use during Conception/Plan. Honor an explicit Worker request; if no suitable Worker is available, report that limitation. Otherwise prefer direct execution unless parallel assignments, a specialist, or an execution environment provides a concrete benefit.",
