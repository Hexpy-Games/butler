...
export function guidedStewardInstructions(
  ...
  return [
    ...
    "A queued Worker assignment does not end your execution. Continue useful independent tools, additional assignments, or steering. When you need the Worker result before proceeding, call wait_for_worker to suspend without a final report or Work disposition. Worker results and incoming directions resume this same session; handle failures and cancellations too before deciding the Work outcome.",
