...
const DUTIES = {
  ...
  review_plan_exactly: [
    ...
    "each subject lists only its applicable findingRootCauseKeys, while the Finding names",
    "all affectedSubjectIds. Resolve all review-relevant observations before submitting",
  ...
  review_task_independently: [
    ...
    "ref in top-level findings. Each criterion verdict lists only applicable",
    "findingRootCauseKeys; never repeat or paraphrase the Finding body. When",
    "priorCorrectionFindings is",
    "present, an unresolved",
    "blocker must reference its exact prior finding identity without changing its statement,",
    "category, or priority. A correction_regression must name the one prior finding whose",
    "repair caused it; never create more blocking regressions than the frozen finding set.",
  ...
  review_correction_exactly: [
    ...
    "one priority-ordered Finding. A re-review may only retain or close that frozen root",
    "Finding; independent late improvements are backlog-only.",
  ].join(" "),
