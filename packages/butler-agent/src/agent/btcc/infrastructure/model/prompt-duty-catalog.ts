...
const DUTIES = {
  ...
  review_plan_exactly: [
    ...
    "entry for every schema dimension. Attach every material defect to its accountable",
    "subject and dimension. Resolve all review-relevant observations before submitting",
  ...
  review_task_independently: [
    ...
    "ref. Attach that exact Finding definition to each affected criterion; never create",
    "paraphrased duplicates for the same correction. When priorCorrectionFindings is",
