...
const DUTIES = {
  ...
  author_smallest_sufficient_plan: [
    ...
    "When priorPlanningObservationResultIndex is present, read the exact stable result",
    "through read_operation_result instead of repeating its source operation. Observe",
