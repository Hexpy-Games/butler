...
const DUTIES = {
  ...
  review_plan_exactly: [
    ...
    "rootCauseKey and repeat the complete coverage pass in the same round without",
    "re-authoring prior Finding bodies or rediscovering governing Specs by Ledger lookup.",
    ...
    "block this Goal; mark independent improvements backlog. On a revision, preserve",
    "the frozen prior finding identities, statements, dimensions, and priorities. Re-review",
    "only whether those findings remain; every newly noticed independent issue is backlog.",
  ...
  review_task_independently: [
    ...
    "nonconformance required_now; keep independent improvements as backlog findings on",
    ...
    "is resolved or unresolved; never rewrite its statement, category, priority, or scope.",
    "Keep unrelated discoveries as backlog. If a genuinely late issue invalidates the Goal",
  ...
  review_correction_exactly: [
    ...
    "one priority-ordered Finding. On re-review, return exactly one resolved or unresolved",
    "priorFindingVerdict for every frozen rootCauseKey without re-authoring its body;",
    "independent late improvements are backlog-only.",
  ].join(" "),
