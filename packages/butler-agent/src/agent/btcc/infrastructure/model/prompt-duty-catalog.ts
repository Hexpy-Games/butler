...
const DUTIES = {
  ...
  choose_direct_assisted_or_deepen: [
    ...
    "read-only state plus the response is required; or target_change, persistent_artifact,",
    ...
    "A semantically resumed deferred or user-stopped Program is durable_work for the whole",
    "remaining obligation even when its immediate next action is only reading an accepted",
    "Result, Review, Consolidation, or Reporting. Propose that exact admitted candidate with",
    "managed_program_continuation and its continuationCandidateId. Assisted is only for a",
    ...
    "When a typed continuation candidate is admitted, submit cancel_work only when",
    "the current request semantically asks to abandon that exact Managed Program.",
  ...
  review_continuation_coherence: [
    "Select a deferred or user-stopped continuation only when its projected original goal, blocker",
