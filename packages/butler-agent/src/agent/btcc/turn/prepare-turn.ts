...
import {
  assertStableRequestIdentity,
  type StableTurnRequestIdentity,
} from "./load-or-admit-turn.ts";
import type { TurnRecord, TurnStateRepository } from "./contracts.ts";
...
function requestIdentityForRequest(request: BtccTurnRequest): StableTurnRequestIdentity {
...
function replayBinding(turn: TurnRecord, request: BtccTurnRequest): StoredSessionBinding {
...
function destinationForRequest(request: BtccTurnRequest) {
...
function inboundEnvelopeFor(request: BtccTurnRequest): InboundEnvelope {
  return {
