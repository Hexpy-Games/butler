...
const ENV_KEYS: Record<keyof TurnContinuationBudgetLimits, string> = {
  maxModelRequests: "BUTLER_CONTINUATION_MAX_MODEL_REQUESTS",
  maxToolRounds: "BUTLER_CONTINUATION_MAX_TOOL_ROUNDS",
  maxModelFacingBytes: "BUTLER_CONTINUATION_MAX_MODEL_FACING_BYTES",
  maxCumulativeModelFacingBytes:
    "BUTLER_CONTINUATION_MAX_CUMULATIVE_MODEL_FACING_BYTES",
  maxOutputBytes: "BUTLER_CONTINUATION_MAX_OUTPUT_BYTES",
  maxElapsedMs: "BUTLER_CONTINUATION_MAX_ELAPSED_MS",
  maxIdleMs: "BUTLER_CONTINUATION_MAX_IDLE_MS",
};

export function selectTurnContinuationBudget(
  env: Record<string, string | undefined> = process.env,
): TurnContinuationBudgetLimits | null {
  const flag = (env.BUTLER_BOUNDED_STATELESS_CONTEXT ?? "")
    .trim().toLowerCase();
