...
import { taskIdFromToolResult } from "./native-tool-result-text.ts";
import {
...
import type { NativeAuditedToolExecutorInput, NativeToolCall } from "./native-audited-executor-types.ts";
