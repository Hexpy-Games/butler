...
export const TURN_INTERRUPTION_PRODUCERS = [
  ...
  producer("app_failure_projection", "projection", "gateways/app/infrastructure/transport/projected-turn-failure.ts", "projectAppTurnFailure", ["app", "queued"], ["turn.failed event", "runtime_fault state", "failed state"], "typed_agent_outbox_projection"),
  ...
  producer("app_responder_timeout", "legacy_responder", "gateways/app/infrastructure/transport/responder-timeout.ts", "AppResponderTimeoutError", ["direct", "system"], ["timeout terminal"], "turn_interruption_router"),
