...
function appendFixedToolInstructions(
  ...
  const instructions = [
    ...
    "- Public decision protocol after the opening batch: `title: <one-line immediate work label>` / `summary: <immediate action>` / `rationale: <why now>` / `next_step: <how the result determines the following step>`.",
