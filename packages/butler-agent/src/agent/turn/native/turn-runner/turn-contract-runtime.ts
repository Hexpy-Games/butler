...
export function contractExecutionPrompt(input: {
  ...
  return [
    ...
    "Execute only the immediate next semantic step. Before every tool batch, write a fresh visible decision explaining that step.",
...
function publicDecisionForContract(
  ...
  return {
    ...
    summary: nextStep,
    rationale: decision.public_summary,
    nextStep,
    evidenceRefs: [],
