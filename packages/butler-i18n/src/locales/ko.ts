...
export const koKrCopy: AppCopy = {
  projectSignpost: {
    ...
    timelineHelp: "보존된 등록·갱신 시점입니다. 점 사이의 간격은 실행 시간이나 대기 시간이 아닙니다.",
    parentWork: "상위 Work", allWork: "모든 Work",
    userMessages: "사용자 메시지", activeConversations: "사용자 메시지가 있는 대화", workChanges: "기록된 작업 변화",
    statisticsHelp: "오늘은 아직 끝나지 않은 구간입니다. 메시지 수는 대화 활동이며 작업량·생산성이 아닙니다. 점을 선택하면 값을 볼 수 있습니다.",
    timelineLimited: "조회 가능한 최근 기록만 표시하며, 전체 작업 상태의 이력은 아닙니다.",
