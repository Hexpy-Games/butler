...
export const koKrCopy: AppCopy = {
  projectStatistics: {
    ...
    densityLegend: "색상별 하루 활동 항목 수",
    densityLevels: ["0개", "1개", "2–4개", "5–9개", "10개 이상", "확인 불가"],
    activeItems: (count) => `총 ${count}개`,
    calendarExample: "예: 대화 2개 + 작업 1개 + 자료 1개 = 4개. 같은 항목은 하루에 한 번만 셉니다. 메시지 수나 완료율이 아닙니다.",
    ...
    focus: "어떤 일을 다뤘나요", focusHelp: "Work에 기록된 변경과 활동 날짜입니다. 개별 도구 호출은 추가 작업으로 세지 않습니다.",
