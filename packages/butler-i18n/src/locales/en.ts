...
export const enUsCopy: AppCopy = {
  projectSignpost: {
    ...
    timelineHelp: "Recorded registration and update times. The distance between points is not execution or waiting time.",
    parentWork: "Parent Work", allWork: "All Work",
    userMessages: "User messages", activeConversations: "Conversations with user messages", workChanges: "Recorded work changes",
    statisticsHelp: "Today is incomplete. Message counts describe conversation activity, not effort or productivity. Select a point to see its value.",
    timelineLimited: "Only the available recent records are shown; this is not a complete work-state history.",
