...
export const enUsCopy: AppCopy = {
  projectStatistics: {
    ...
    calendar: "Project activity", calendarHelp: "Stronger color means more recorded activity. Select a date to inspect its records. Activity is not completion progress.",
    densityLegend: "Activity: 0 · 1 · 2–4 · 5–9 · 10+ / Dashed: no data",
