...
export const enUsCopy: AppCopy = {
  projectStatistics: {
    ...
    calendar: "Project activity", calendarHelp: "Each square is one day. Darker color means more active conversations, changed work items, and created or updated materials. Select a date to see its records.",
    densityLegend: "Active items per day, by color",
    densityLevels: ["0 items", "1 item", "2–4 items", "5–9 items", "10+ items", "Unavailable"],
    activeItems: (count) => `${count} items in total`,
    calendarExample: "Example: 2 conversations + 1 work item + 1 material = 4 items. Each item counts once per day, not once per message. This is not completion progress.",
    ...
    focus: "Where activity went", focusHelp: "Recorded Work changes and the dates they occurred. Tool calls are not counted as extra work.",
